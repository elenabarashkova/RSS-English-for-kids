...
const content = (`
  <div class="win-info">
    You successfully found all matches on <span id="gameDuration"></span>. Your score is <b><span id="gameScore"></span></b>.
  </div> 
...
export const startWinPopup = (gameDuration: string, score: number) => {
